...
<body id=white>
    <div class="container login-wrap" id="container">
        ...
        <div id="response"></div>
            ...
            <h5 style="margin-top:10px;">Enter Your password</h5>
            <div class="lockscreen-item">
                ...
                <p id="errors"></p>
                <!-- <p id="response"></p> -->
                <div class="help-block text-center" style="margin-top:70px;">
                <a href="resentpassword.php">Resent Your Password in email</a>
                </div>
